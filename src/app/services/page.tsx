...
import { ArrowRight, Shield, TrainTrack, Ticket, TrainFront, Flame, Building2, HardHat } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Steam Railroad Insurance Services",
  description: `Complete insurance coverage for heritage steam railroads — general liability, railroad liability, passenger liability, rolling stock & equipment, boiler & machinery, commercial property, and workers' compensation. ${SITE.statesLicensed}.`,
};
        ...
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              ...
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Steam Railroad Insurance</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Every policy a heritage steam railroad operator needs — in one place, from specialists who know the rails.
              </p>
            </FadeIn>
          </div>
        </section>
