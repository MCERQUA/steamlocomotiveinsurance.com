        ...
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              ...
              <p className="font-body text-white/80 text-lg max-w-xl">Get in touch with our heritage steam railroad insurance specialists. Same-day response, same-day quotes.</p>
            </FadeIn>
          </div>
        </section>
