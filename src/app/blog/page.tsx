...
export const metadata: Metadata = {
  title: "Steam Railroad Insurance Blog",
  description: `Guides on general liability, railroad liability, passenger excursion risk, and boiler & machinery coverage for heritage steam railroads. Expert advice from ${SITE.name}.`,
};
      ...
      <main>
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Steam Railroad Insurance Blog</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Expert guides on insurance for heritage steam railroads, excursion operators, and restoration shops.
              </p>
            </FadeIn>
          </div>
        </section>
